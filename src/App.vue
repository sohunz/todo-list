  ...
  <div class="container-fluid mt-5">
    <div class="wrapper-todo m-auto p-5 rounded-2">
      ...
      <div class="lists">
        ...
        <div class=" list border border-1 rounded-2 p-2 my-2"  v-for="(todo, index) in todos" :key="index">
          <div class="title-add w-75">{{ todo.text }}</div>
          <div class="action" style="display: flex; align-items: center">
            <button class="done btn btn-primary mx-2">Done</button>
            <button class="delete btn btn-danger" @click="removeTodo(index)">Delete</button>
          </div>
        </div>
      </div>
    </div>
